...
FROM (SELECT import_id, ship_name, ship_name_unified, direction, is_empty, date, terminal, container_number, count_dupl_cont_num, container_size, container_type, container_type_unified, goods_name_rus, shipper, line, line_unified, consignment, min_consignment, count, '0' AS count_main, teu, voyage, shipper_country, goods_weight, package_number, city, shipper_seaport, year, month, goods_tnved, parsed_on, year_parsed_on, month_parsed_on, consignee, consignee_inn, consignee_name_unified, seaport, seaport_unified, country, region, tnved_group_name, lat_port, long_port
FROM (
  SELECT import_id, ship_name, ship_name_unified, direction, is_empty, date, terminal, container_number, count_dupl_cont_num, container_size, container_type, container_type_unified, goods_name_rus, consignment, shipper, line, line_unified, count, teu, voyage, shipper_country, goods_weight, package_number, city, shipper_seaport, year, month, goods_tnved, parsed_on, year_parsed_on, month_parsed_on, consignee, consignee_inn, consignee_name_unified, seaport, seaport_unified, country, region, tnved_group_name, lat_port, long_port,
