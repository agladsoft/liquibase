...
(
    ...
    `departure_date` Date,
    `departure_month_from_date` Nullable(Int32) DEFAULT toMonth(departure_date),
    `departure_year_from_date` Nullable(Int32) DEFAULT toYear(departure_date),
    ...
    `common_shipper` Nullable(String) DEFAULT swap_values(shipper_by_puzt, shipper_according_to_egrpo, 'неизвестен'),
    ...
    `common_consignee` Nullable(String) DEFAULT swap_values(consignee_by_puzt, consignee_according_to_egrpo, 'неизвестен'),
    `consignee_okpo` Nullable(String),
    `container_tonnage` Nullable(String),
    `container_tonnage_unified` Nullable(Int32),
