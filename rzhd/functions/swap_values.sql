...
multiIf(
    toInt64OrNull(attendee_by_puzt) is not null and (attendee_according_to_egrpo is null
    ...
    default_value,
    toInt64OrNull(attendee_by_puzt) is not null and not (attendee_according_to_egrpo is null
        or attendee_according_to_egrpo = 'неизвестен ОКПО' or attendee_according_to_egrpo = 'неизвестен'
        or toInt64OrNull(attendee_according_to_egrpo) is not null),
    ...
    attendee_by_puzt = 'неизвестен' and not (attendee_according_to_egrpo is null
        ...
        or toInt64OrNull(attendee_according_to_egrpo) is not null),
    attendee_according_to_egrpo,
    attendee_by_puzt is null and not (attendee_according_to_egrpo is null
        or attendee_according_to_egrpo = 'неизвестен ОКПО' or attendee_according_to_egrpo = 'неизвестен'
        or toInt64OrNull(attendee_according_to_egrpo) is not null),
    attendee_according_to_egrpo,
    attendee_by_puzt
