...
CASE
	...
	ELSE teu
END AS teu_main,
container_count, container_count_main, is_empty, goods_name, tnved, tnved_group_name, goods_weight_netto, goods_weight_brutto, shipper_name, consignee_name, consignee_inn, consignee_name_unified, city, tracking_country_unified, tracking_seaport_unified, region, lat_port, long_port
