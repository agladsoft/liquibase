...
AS SELECT
    ...
    FROM import WHERE (is_auto_tracking = true) AND (is_auto_tracking_ok = false)
   ...
   SELECT
        ...
        original_file_name as original_file_name,
        original_file_parsed_on as original_file_parsed_on
    FROM export WHERE (is_auto_tracking = true) AND (is_auto_tracking_ok = false)
    UNION ALL
   SELECT
        uuid as uuid,
        month as month,
        ...
        original_file_name as original_file_name,
        original_file_parsed_on as original_file_parsed_on
    FROM export_nw WHERE (is_auto_tracking = true) AND (is_auto_tracking_ok = false)
    UNION ALL
   SELECT
        uuid as uuid,
        month as month,
