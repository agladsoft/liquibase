CREATE MATERIALIZED VIEW default.all_enriched_live_line_report
...
(
    ...
    `goods_weight_with_package` Nullable(Decimal(38,
 19)),
...
ORDER BY month
POPULATE AS
SELECT * FROM default.all_enriched_line_report
SETTINGS
