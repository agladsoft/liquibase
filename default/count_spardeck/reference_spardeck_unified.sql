...
AS SELECT operator, rl.line_unified AS line_unified, vessel, rs.ship_name_unified AS ship_name_unified, atb_moor_pier, month, year, toInt32(total_volume_in) - if(volume_in_nutep is null, 0, toInt32(volume_in_nutep)) as total_volume_in
