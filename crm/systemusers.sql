CREATE TABLE IF NOT EXISTS crm.systemusers
    ...
    `invitestatuscode` Nullable(Bigint),
    `defaultodbfoldername` Nullable(String),
    `caltype` Nullable(Bigint),
    `modifiedon` Nullable(Date),
    `defaultfilterspopulated` Nullable(Bool),
    `outgoingemaildeliverymethod` Nullable(Bigint),
    `emailrouteraccessapproval` Nullable(Bigint),
    `versionnumber` Integer,
    `kc_initialseng` Nullable(String),
    `mobilephone` Nullable(String),
    `setupuser` Nullable(Bool),
    `userlicensetype` Nullable(Bigint),
    ...
    `preferredaddresscode` Nullable(Bigint),
    ...
    `preferredphonecode` Nullable(Bigint),
    ...
    `trx_extension` Nullable(Bigint),
    `address1_latitude` Nullable(String),
    `entityimage_timestamp` Nullable(Bigint),
    ...
    `preferredemailcode` Nullable(Bigint),
