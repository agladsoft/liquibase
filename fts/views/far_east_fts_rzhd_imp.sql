...
AS SELECT 
    ...
    ROW_NUMBER() OVER (PARTITION BY fts_month, fts_year, code_gng, ktk.name_of_cargo,
        ktk.destination_region, ktk.rf_destination_station,
...
INNER JOIN (SELECT departure_month, departure_year,
                cargo_code_according_to_the_harmonized_nomenclature_of_goods_gng AS cargo_code_gng, name_of_cargo,
			...
			GROUP BY departure_month, departure_year, cargo_code_gng, name_of_cargo,
